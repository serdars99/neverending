...
namespace neverending
{
    ...
    public partial class Model1 : DbContext
    {
        ...
        public virtual DbSet<ItemLike> ItemLike { get; set; }
        public virtual DbSet<ItemLikeType> ItemLikeType { get; set; }
        public virtual DbSet<Job> Job { get; set; }
        public virtual DbSet<JobWorkLog> JobWorkLog { get; set; }
        public virtual DbSet<Member> Member { get; set; }
        public virtual DbSet<Parameter> Parameter { get; set; }
        public virtual DbSet<Story> Story { get; set; }
        public virtual DbSet<StoryMember> StoryMember { get; set; }
        public virtual DbSet<StoryMemberType> StoryMemberType { get; set; }
        public virtual DbSet<StoryState> StoryState { get; set; }
        public virtual DbSet<Tag> Tag { get; set; }
        public virtual DbSet<TagType> TagType { get; set; }
        public virtual DbSet<Entry> Entry { get; set; }
        public virtual DbSet<Follow> Follow { get; set; }
    
        public virtual int CalculateVotes()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CalculateVotes");
        }
        ...
        public virtual int FixStoryPages(Nullable<int> storyID)
        {
            var storyIDParameter = storyID.HasValue ?
                new ObjectParameter("StoryID", storyID) :
                new ObjectParameter("StoryID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("FixStoryPages", storyIDParameter);
        }
    }
}
